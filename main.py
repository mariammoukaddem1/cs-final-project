...
# Sidebar navigation using Streamlit widgets
...
st.info("Developed by Mariam Moukaddem. Data sourced from Boston Bluebikes. Analysis performed using Python and Streamlit.")
